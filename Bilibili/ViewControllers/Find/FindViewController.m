...
@interface FindViewController () <UIGestureRecognizerDelegate ,UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>
{
...
//@property (nonatomic,assign)TagListViewMode tagListViewMode;
...
- (void)loadSubviews {
    ...
    //二维码按钮
    QRcode_btn = [UIButton buttonWithType:UIButtonTypeCustom];
    ...
    //    contentView.backgroundColor = CRed;
    ...
    [FindViewData getKeyword:^(NSMutableArray *keyword_arr) {
    ...
    tagList_btn = [UIButton buttonWithType:UIButtonTypeCustom];
    ...
    //    tabelView.backgroundColor = CRed;
    tabelView.separatorStyle = UITableViewCellSeparatorStyleNone;
    tabelView.backgroundColor = ColorRGB(243, 243, 243);
    tabelView.showsVerticalScrollIndicator = YES;
